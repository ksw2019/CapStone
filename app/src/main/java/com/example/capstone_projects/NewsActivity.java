...
public class NewsActivity extends AppCompatActivity {
    ...
    String category = "";
    String[] spinnerArray = new String[]{"카테고리를 선택해주세요.","news", "book", "cafearticle", "kin","local"};
    String[] koreaArray = new String[]{"카테고리를 선택해주세요.","뉴스", "책", "네이버 카페", "지식 IN","지역"};
        ...
        else
        {
            new Thread() {
                ...
                public void run() {
                    ...
                    String clientId = "nUNtK9mdGr9V4VFVktdb";//애플리케이션 클라이언트 아이디값";
                    String clientSecret = "LB01q2_yxw";//애플리케이션 클라이언트 시크릿값";
                    try {
